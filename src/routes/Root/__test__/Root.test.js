...
const MockRoot = () => <RouterProvider router={mockedRouter} />;

// 模擬 React Router 的 useLoaderData 函式所返回的資料
  ...
  films: [
    {
      ...
      original_title_romanized: "Tenkū no shiro Rapyuta",
      image:
...
describe("Root", () => {
  it("should render heading", () => {
    render(<MockRoot />);
    const headingElement = screen.getByText(/Studio Ghibli Films/i);
